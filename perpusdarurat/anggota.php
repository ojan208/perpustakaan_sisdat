            ...
            <div class="row g-3">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left" style="text-align:center;">Informasi Anggota</h2>
                        <div class="row g-3">
                            <div class="col">
                                <a href="createang.php" class="btn btn-success ">Tambah Baru</a>
                            </div>
                    ...
                    if ($result = mysqli_query($db, $sql)) {
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                echo "<td>";
                                echo "<a href='updateanggota.php?id_anggota=" . $row['id_anggota'] . "' class='btn btn-primary pull-right'>Edit </a>";
                                echo "<a href='delanggota.php?id_anggota=" . $row['id_anggota'] . "'  class='btn btn-danger mx-3  pull-right'>Delete </a>";
